                     ...
                     <div class="col-12 grid-margin stretch-card">
                         <div class="card">
                             <div class="card-body">
                                 ...
                                 <form action="/friends" method="POST" class="forms-sample">
                                     @csrf
                                     ...
                                     <div class="form-group">
                                         <label for="exampleInputPassword4">No TLP</label>
                                         <input type="text" class="form-control" name="no_tlp"
                                             id="exampleInputPassword4" placeholder="No TLP"
                                             value="{{ old('no_tlp') }}">
                                         @error('no_tlp')
                                     ...
                                     <div class="form-group">
                                         ...
                                         <input type="text" class="form-control" name="alamat" id="exampleInputCity1"
                                             placeholder="ALAMAT" value="{{ old('no_tlp') }}">
                                         @error('alamat')
                                             <div class=" alert alert-danger">{{ $massage }}
                                             </div>
                                         @enderror
